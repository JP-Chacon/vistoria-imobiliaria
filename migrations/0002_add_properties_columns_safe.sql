-- Migration segura para adicionar/corrigir colunas à tabela properties
-- Esta migration corrige o problema da migration 0001 que falhou ao adicionar colunas NOT NULL
